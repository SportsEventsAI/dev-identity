...
const defaultSearchData: ItemsSearchData = {
    type: EItemSearchType.metadata,
    text: '',
};
...
export const ItemsSearchForm: FC<ItemsSearchFormProps> = ({ handleSearch, handleReset }) => {
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<ItemsSearchData>({ defaultValues: defaultSearchData });
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-row">
                ...
                <div className="form-group col-2">
                    {/* Do search */}
                    <button type="submit" className="btn btn-outline-success" aria-label="Search">
